...
def test_if_change_min_some_can_be_withdraw_easy(setup_strat, sett, deployer, want):
  ...
  assert want.balanceOf(deployer) > initial_b ## You can withdraw as long as it's less than min
  

def test_wait_for_all_locks_can_withdraw_easy(setup_strat, deployer, sett, strategy, want, locker):
